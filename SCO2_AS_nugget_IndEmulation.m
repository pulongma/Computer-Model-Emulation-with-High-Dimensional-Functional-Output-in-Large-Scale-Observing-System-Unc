...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% The following routine implements the independent NNGP emulator for the SCO2 band
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%% proposal variance
Delta.tau2=0.1; 
Delta.phi = [0.05, 0.20, 0.09, 0.1, 0.05, 0.1, 0.08, 0.08]; % no nugget
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
    %%%%% update w
    [theta_curr, loglik_curr] = SEP_MwH_Gibbs(Zdata, Ho, theta_curr, B_rowin, B_colin, prior, Delta, array_rho, ...
...
dlmwrite("./Results/OCO2_SCO2_AS_IndEmulation.txt", Zhat)
